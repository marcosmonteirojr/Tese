...
def gera_grafico():
   # pdf_pages = PdfPages('Disp'+nome_base+'.pdf')
    ...
    for i in range(1, 21):
        ...
        arq2 = open('/media/marcos/Data/Tese/ComplexidadeDistancias/'+nome_base+'/' + nome_base + str(i) + '/'+nome_base+'_medias.txt', 'r')
       ...
       # print(mf1)
        ...
        #1if(r<4):
            ...
            plot.savefig(nome_base+str(j)+'.png')
        if (r == 20):
            r = 0
