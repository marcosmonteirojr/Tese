...
def selecao(nome_base,local, cpx_caminho,bags_ga,nome_arq,repeticao):
        ...
        for i in range(100):
          ...
          #  print(X_bag2[1],"\n")
           ...
           # print(X_bag[1])
            ...
            percP = perc.Perceptron(n_jobs=4,max_iter=10,tol=1.0)
    ...
    if os.path.isfile('SelecaoMedia_desvio' + nome_arq + ".csv") == False or os.path.isfile('SelecaoLatex' + nome_arq + '.txt') == False:
        print("kjksjdf")
        arq = open('SelecaoMedia_desvio' + nome_arq + "4.csv", 'a')
        arq1 = open('SelecaoWilcoxon' + nome_arq + "4.csv", 'a')
        arq2 = open('SelecaoTabela' + nome_arq + "4.csv", 'a')
        arq3 = open('SelecaoLatex' + nome_arq + '4.txt', 'a')
