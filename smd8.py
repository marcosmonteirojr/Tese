...
def cria_arquivo_individual(nome_arq, tipo, accVotingPgsc, accVotingPool, accLCAP,
    ...
    MVR_ = open('/home/marcos/Área de Trabalho/d/Selecao_MVR' + nome_arq + ".csv", 'a')
    LCA_ = open('/home/marcos/Área de Trabalho/d/Selecao_LCA' + nome_arq + ".csv", 'a')
    OLA_ = open('/home/marcos/Área de Trabalho/d/Selecao_OLA' + nome_arq + ".csv", 'a')
    RANK_ = open('/home/marcos/Área de Trabalho/d/Selecao_RANK' + nome_arq + ".csv", 'a')
    KNORA_E = open('/home/marcos/Área de Trabalho/d/Selecao_KE' + nome_arq + ".csv", 'a')
    KNORA_U = open('/home/marcos/Área de Trabalho/d/Selecao_KU' + nome_arq + ".csv", 'a')
    META_ = open('/home/marcos/Área de Trabalho/d/Selecao_META' + nome_arq + ".csv", 'a')
    MVR_2 = open('/home/marcos/Área de Trabalho/d/MVR' + nome_arq + ".csv", 'a')
    LCA_2 = open('/home/marcos/Área de Trabalho/d/LCA' + nome_arq + ".csv", 'a')
    OLA_2 = open('/home/marcos/Área de Trabalho/d/OLA' + nome_arq + ".csv", 'a')
    RANK_2 = open('/home/marcos/Área de Trabalho/d/RANK' + nome_arq + ".csv", 'a')
    KNORA_E2 = open('/home/marcos/Área de Trabalho/d/Knora-E' + nome_arq + ".csv", 'a')
    KNORA_U2 = open('/home/marcos/Área de Trabalho/d/Knora-U' + nome_arq + ".csv", 'a')
    META_2 = open('/home/marcos/Área de Trabalho/d/META' + nome_arq + ".csv", 'a')
    ...
    if accVotingPgsc2 and tipo == 'bagging':
        ...
        MVR_2.write('{};{};{};'.format( round(100 * average(accVotingPgsc), 1),
                                          round(100 * average(accVotingPgsc2), 1),
                                          round(100 * average(accVotingPool), 1)))
        ...
        LCA_2.write('{};{};{};'.format(round(100 * average(accLCAP), 1),
                                          round(100 * average(accLCAP2), 1),
                                          round(100 * average(accLCAB), 1)))
        ...
        OLA_2.write('{};{};{};'.format(round(100 * average(accOLAP), 1),
                                          round(100 * average(accOLAP2), 1),
                                          round(100 * average(accOLAB), 1)))
        ...
        RANK_2.write('{};{};{};'.format(round(100 * average(accRankP), 1),
                                           round(100 * average(accRankP2), 1),
                                           round(100 * average(accRankB), 1)))
        ...
        KNORA_E2.write('{};{};{};'.format( round(100 * average(accKEP), 1),
                                             round(100 * average(accKEP2), 1),
                                             round(100 * average(accKEB), 1)))
        ...
        KNORA_U2.write('{};{};{};'.format(round(100 * average(accKUP), 1),
                                             round(100 * average(accKUP2), 1),
                                             round(100 * average(accKUB), 1)))
        ...
        META_2.write('{};{};{};'.format(round(100 * average(accMetaP), 1),
                                           round(100 * average(accMetaP2), 1),
                                           round(100 * average(accMetaB), 1)))
